...
void onInit( CBlob@ this )
{
	...
	if ( getNet().isServer() )
	{
		...
		if ( owner !is null )
		{
			...
			{
				warn("RamChair owner has no player: block=" + this.getNetworkID() + " owner=" + owner.getNetworkID());
...
void onTick( CBlob@ this )
{
	...
	if ( occupier !is null )
	{
		...
		if ( inv && canProduceCoupling && !Human::isHoldingBlocks(occupier) )
		{
			...
			Block::Type[] types = {Block::COUPLING,Block::COUPLING};
			ProduceBlock( rules, occupier, types );
		}
