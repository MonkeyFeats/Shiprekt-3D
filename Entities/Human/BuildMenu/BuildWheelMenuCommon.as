...
class IconWheelMenuEntry : WheelMenuEntry
{
	...
	{
		//GUI::DrawButton(position + (offset - Vec2f(18,18)), position + (offset + Vec2f(16,16)));
...
class WheelMenu
{
	...
	void draw_center_pane()
	{
		...
		GUI::DrawCircle(origin, 63, color_white);

		GUI::DrawTextCentered(option_notice, origin - WheelMenu::center_pane_text_margin	, WheelMenu::pane_title_color);
		GUI::DrawTextCentered(hover_text, 	 origin 										, WheelMenu::pane_text_color);
		GUI::DrawTextCentered(hover_cost, 	 origin + WheelMenu::center_pane_text_margin	, WheelMenu::pane_text_color);
	}
